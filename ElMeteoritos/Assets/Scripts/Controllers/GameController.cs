...
public class GameController : MonoBehaviour
{
    ...
    public GameObject meteoroidPrefab; // ---> A�adir en el inspector de Unity un prefab de cualquier enemigo para hacer pruebas.
    ...
    // ---> Toda la gestion de la interfaz se ha movido (Se puede volver a la que hab�a antes) a PlayerUIManager
    //[Header("Interfaz")]
    ...
    //    }
    //}
    public IEnumerator SpawnPlayers() // ---> Funci�n para spawnear a los juagdores, esperando a que se inicialicen todos para que no fallos. Habr� que cambiar algunas cosas al meter el Photon.
    {
        ...
        PlayerUIManager.instance.InitializePlayersPanel(); // ---> Inicializar los paneles de informaci�n de los jugadores
    }
