...
public class PlayerUIManager : MonoBehaviour
{
    ...
    public void InitializePlayersPanel()
    {
        ...
        {
            GameObject newPlayerPanel = Instantiate(playerPanelPrefab, playersInfoPanel.transform, false);
            RectTransform rectTransform = newPlayerPanel.GetComponent<RectTransform>();
